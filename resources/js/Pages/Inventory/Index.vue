...
const columns = [
    ...
    },
    {
        ...
        render: (data, type, row, meta) => {
            const priority = page.props.priority || null;
            ...
            let order = ['Available', 'Re-order', 'Out of Stock'];
            if (priority && orderMap[priority]) {
                order = orderMap[priority];
            }
            ...
            <span class="${data === 'Available'
                    ? 'bg-indigo-200 text-indigo-800 text-xs font-medium px-2.5 py-1 rounded border border-indigo-400'
                    : data === 'Out of Stock'
                        ? 'bg-rose-200 text-rose-800 text-xs font-medium px-2.5 py-1 rounded border border-rose-400'
                        : data === 'Re-order'
                            ? 'bg-amber-200 text-amber-800 text-xs font-medium px-2.5 py-1 rounded border border-amber-400'
                            : ''
                }">
                ${data}
            </span>
                ...
                <div class="flex items-center bg-zinc-300 border border-zinc-400 rounded-sm overflow-hidden shadow">
                    <div class="p-4 bg-indigo-400">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-white" fill="none"
                            viewBox="0 0 12 12" stroke="currentColor">
                            <path fill="currentColor"
                                d="M6 12A6 6 0 1 0 6 0a6 6 0 0 0 0 12Zm2.53-6.72L5.78 8.03a.75.75 0 0 1-1.06 0l-1-1a.75.75 0 0 1 1.06-1.06l.47.47l2.22-2.22a.75.75 0 0 1 1.06 1.06Z" />
                        </svg>
                    </div>
                    ...
                    <div class="p-4 bg-yellow-400">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-white" fill="none"
                            ...
                            <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2">
                                <path
                                    d="M3 16a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1zm7 0a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1zm7 0a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1zM5 11V8a3 3 0 0 1 3-3h8a3 3 0 0 1 3 3v3" />
                    ...
                    <div class="p-4 bg-red-400">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-white" fill="none"
                            ...
                            <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="1.5"
                                d="M12 22c-.818 0-1.6-.33-3.163-.988C4.946 19.373 3 18.554 3 17.175V7.542M12 22c.818 0 1.6-.33 3.163-.988C19.054 19.373 21 18.554 21 17.175V7.542M12 22v-9.97m9-4.488c0 .613-.802 1-2.405 1.773l-2.92 1.41c-1.804.87-2.705 1.304-3.675 1.304m9-4.487c0-.612-.802-.999-2.405-1.772L17 5M3 7.542c0 .613.802 1 2.405 1.773l2.92 1.41c1.804.87 2.705 1.304 3.675 1.304M3 7.542c0-.612.802-.999 2.405-1.772L7 5m-1 8.026l2 .997M10 2l2 2m0 0l2 2m-2-2l-2 2m2-2l2-2"
                                color="currentColor" />
                        </svg>
                    </div>
                    <div class="px-4 text-gray-700">
            ...
            <div class="my-4">
                <div class="bg-zinc-300 relative p-4 overflow-x-auto md:overflow-hidden shadow-md rounded-md">
                    <DataTable class="display table-hover table-striped shadow-lg rounded-lg bg-zinc-100"
                        :columns="columns" :data="reformatInventory" :options="{
                            paging: true,
                            searching: true,
                            ordering: true,
                            order: [[6, 'asc']]
                        ...
                        <template #action="props">
                            <button @click="openEditModal(props.cellData)" class="m-1" title="Edit">
                                <svg class="w-6 h-6 text-orange-700 hover:text-indigo-900" aria-hidden="true"
                                    fill="currentColor" xmlns="http://www.w3.org/2000/svg" width="200" height="200"
                                    viewBox="0 0 576 512">
                                    <path fill="currentColor"
                            ...
                            <button @click="openAddModal(props.cellData)" class="m-1" title="Add">
                                <svg class="w-6 h-6 text-blue-700 hover:text-indigo-900" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" width="200" height="200" ill="currentColor"
                                    viewBox="0 0 48 48">
                                    <mask id="ipTAdd0">
                ...
                <div class="bg-zinc-300 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="w-full mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 class="text-lg leading-6 text-[#040130] font-semibold" id="modal-headline"> Update
                                Product
                                Inventory</h3>
                            <p class="text-sm text-zinc-700">This function is dedicated solely to data initialization,
                                such as
                                inputting the beginning balance or reconciling product items quantity.</p>
                            <div class="mt-3">
                                <p class="text-sm text-[#040130] font-semibold"> Product Information: </p>
                                <div class="relative mt-1">
                                    <div
                                        class="absolute inset-y-0 left-0 pt-2 flex items-center pl-3 pointer-events-none">
                                        <span class="text-zinc-700 text-sm font-semibold">Stock No: </span>
                                    </div>
                                    <input v-model="addParticular.stockNo" type="text" id="stockNo"
                                        class="mt-2 pl-20 p-2.5 bg-gray-200 border border-gray-300 rounded-md w-full focus:outline-none focus:ring focus:border-indigo-500"
                                        placeholder="Ex. 01-01-10" readonly>
                                </div>
                                <div class="relative mt-1">
                                    <div
                                        class="absolute inset-y-0 left-0 pt-2 flex items-center pl-3 pointer-events-none">
                                    ...
                                    <textarea v-model="addParticular.desc" type="text" id="stockNo"
                                        class="mt-2 pl-24 p-2.5 bg-gray-200 border border-gray-300 rounded-md w-full h-auto focus:outline-none focus:ring focus:border-indigo-500"
                                        placeholder="Ex. 01-01-10" readonly> </textarea>
                                </div>
                            </div>
                            <div class="mt-5">
                                ...
                                <div class="relative mt-1">
                                    ...
                                    <input v-model="addParticular.qty" type="number" id="stockNo"
                                        class="mt-2 pl-20 p-2.5 border border-gray-300 rounded-md w-full focus:outline-none focus:ring focus:border-indigo-500"
                                ...
                                <div class="relative mt-1">
                                    ...
                                    <input v-model="addParticular.remarks" type="text" id="stockNo"
                                        class="mt-2 pl-20 p-2.5 border border-gray-300 rounded-md w-full focus:outline-none focus:ring focus:border-indigo-500"
                                        placeholder="Ex. Beginning Balance" required>
                                </div>
                                <div class="relative mt-1">
                                    <div
                                        class="absolute inset-y-0 left-0 pt-2 flex items-center pl-3 pointer-events-none">
                                    ...
                                    <input v-model="addParticular.dateOfAdjustment" type="date" id="dateOfAdjustment"
                ...
                <div class="bg-zinc-300 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="w-full mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 class="text-lg leading-6 text-[#040130] font-semibold" id="modal-headline">Update
                                Product Item
                                Inventory Reorder Level / Threshold</h3>
                            <p class="text-sm text-zinc-700">This functionality is designed exclusively for configuring
                                item
                                reorder levels.</p>
                            <div class="mt-3">
                                <p class="text-sm text-[#040130] font-semibold"> Product Information: </p>
                                <div class="relative mt-1">
                                    ...
                                    <input v-model="editParticular.stockNo" type="text" id="stockNo"
                                        class="mt-2 pl-20 p-2.5 bg-gray-200 border border-gray-300 rounded-md w-full focus:outline-none focus:ring focus:border-indigo-500"
                                        placeholder="Ex. 01-01-10" readonly>
                                </div>
                                <div class="relative mt-1">
                                    ...
                                    <input v-model="editParticular.desc" type="text" id="stockNo"
                                        class="mt-2 pl-24 p-2.5 bg-gray-200 border border-gray-300 rounded-md w-full focus:outline-none focus:ring focus:border-indigo-500"
                                        placeholder="Ex. 01-01-10" readonly>
                                </div>
                            </div>
                            <div class="mt-5">
                                ...
                                <div class="relative mt-1">
                                    ...
                                    <input v-model="editParticular.reorder" type="text" id="stockNo"
                                        class="mt-2 pl-20 p-2.5 border border-gray-300 rounded-md w-full focus:outline-none focus:ring focus:border-indigo-500"
                                        placeholder="Ex. Reconciled Quantity" required>
                                </div>
                            </div>
                        </div>
                    </div>
