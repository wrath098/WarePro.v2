    ...
    <AuthenticatedLayout>
        ...
        <section class="py-8">
            <div class="max-w-screen-2xl mx-auto sm:px-6 lg:px-2">
                <div class="mx-2 bg-white p-4 rounded-md shadow">
                    ...
                    <div class="grid lg:grid-cols-2 lg:gap-6 my-5">
                    ...
                    <div v-if="stockData" class="mt-2 px-4">
                        ...
                        <div class="px-5 mb-2 grid lg:grid-cols-2 lg:gap-6 my-5">
                            <div>
                                <p class="text-base text-gray-500">
                                    <strong class="font-semibold">Stock No:</strong> 
                                    {{ stockData.prodStockNo }}
                                </p>
                                <p class="text-base text-gray-500">
                                ...
                                <p class="text-base text-gray-500">
                                <strong class="font-semibold">Available Stock :</strong> 
                                    {{ stockData.availableStock }}
                                </p>
                            </div>
                            <div>
                                <p class="text-base text-gray-500">
                                    <strong class="font-semibold">1st Sem (qty requested) :</strong> 
                                    {{ stockData.treshFirstQty }}
                                </p>
                                <p class="text-base text-gray-500">
                                    <strong class="font-semibold">2nd Sem (qty requested) :</strong> 
                                    {{ stockData.treshSecondQty }}
                                </p>
                                <p class="text-base text-gray-500">
                                    <strong class="font-semibold">Total Issued Qty :</strong> 
                                    {{ stockData.releasedQty }}
                                </p>
                            </div>
                            <div>
                                <label for="quantity"><strong class="text-base text-gray-500 font-semibold">Requested Quantity: </strong></label>
                                <input 
                                    type="number" 
                                    id="quantity" 
                            ...
                            <AddButton v-if="stockData.availableStock > 0" @click="addToRequestData">Add To Cart </AddButton>
                        </div>
                    </div>
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-700 rounded-md">
                            ...
                            <tbody>
                                <tr v-for="(item,index) in requestData" :key=index class="odd:bg-white even:bg-gray-100 border-b">
                                    ...
                                    <td scope="col" class="py-3 text-center">{{ item.prodStockNo }}</td>
                                    <td scope="col" class="py-3">{{ item.prodDesc }}</td>
                                    <td scope="col" class="py-3 text-center">{{ item.prodUnit }}</td>
