        ...
        },
        {
            ...
            render: (data, type, row) => {
                ...
                <span class="${data === 'Deactivated' 
                    ? 'bg-rose-200 text-rose-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded border border-rose-400' 
                    : ''}">
                    ${data}
                </span>
                `;
                ...
                <div class="bg-zinc-300 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="w-full mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 class="text-lg leading-6 font-semibold text-[#1a0037]" id="modal-headline"> New Item Class</h3>
                            <p class="text-sm text-zinc-700"> Enter the details for the new Item Class you wish to add.</p>

                            <div class="mt-10">
                                <div class="relative z-0 w-full mb-5 group">
                                    <select v-model="form.catId" name="catId" id="catId" class="block py-2.5 px-1 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-700 appearance-none focus:outline-none focus:ring-0 focus:border-indigo-600 peer" required>
                                        <option value="" disabled selected class="pl-5">Please choose the category applicable</option>
                                        <option v-for="category in categories" :key="category.id" :value="category.id">
                                            {{ category.name }}
                                        </option>
                                    </select>
                                    <label for="catId" class="font-semibold text-zinc-700 absolute text-sm duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-indigo-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Category</label>
                                </div>
                                ...
                                <div class="relative z-0 w-full group my-1">
                                    <input v-model="form.itemName" type="text" name="itemName" id="itemName" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-700 appearance-none focus:outline-none focus:ring-0 focus:border-indigo-600 peer" placeholder="" required/>
                                    <label for="itemName" class="font-semibold text-zinc-700 absolute text-sm duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-indigo-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Item Name</label>
            ...
            <form @submit.prevent="submitEdit">
                <div class="bg-zinc-300 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="w-full mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 class="text-lg leading-6 font-semibold text-[#1a0037]" id="modal-headline"> Edit Item Class</h3>
                            <p class="text-sm text-zinc-700"> Edit the detail below for the Item Class you wish to update.</p>
                            <div class="mt-10">
                                ...
                                <div class="relative z-0 w-full group my-1">
                                    ...
                                    <label for="editItemName" class="font-semibold text-zinc-700 absolute text-sm duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Item Name</label>
                ...
                <div class="bg-zinc-300 h-auto">
                    <div class="p-6  md:mx-auto">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-zinc-700 my-2">Confirming this action will remove the selected Item Class into the list. you can't redo this</p>
