<script setup>
    ...
    watch(search, debounce(function (value) {
        router.get('unmodified', { search: value }, {
            preserveState: true,
            preserveScroll:true,
            replace:true
        });
        ...
        <template #header>
            <nav aria-label="breadcrumb" class="font-semibold text-lg leading-3"> 
                <ol class="flex space-x-2">
                    <li class="text-green-700" aria-current="page">Unmodified Products</li> 
                </ol>
            </nav>
                    ...
                    <div class="relative overflow-x-auto">
                        <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
                            ...
                            <div class="relative">
                                ...
                                <input v-model="search" type="text" id="search" class="block p-2 ps-10 text-sm text-gray-900 border border-indigo-600 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400 " placeholder="Search for Product No., Product Description">
                            </div>
                        </div>
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="w-full mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-headline">Add New Product to be Unmodified</h3>
                            <div class="mt-2">
                                <p class="text-sm text-gray-500"> Enter the details of the Product you wish to add on unmodified.</p>
                                <div class="mt-5">
                                    <p class="text-sm text-gray-500">Enter Product Code</p>
                                    <input type="text" v-model="create.prodCode" class="mt-2 p-2 border border-gray-300 rounded-md w-full focus:outline-none focus:ring focus:border-indigo-500" placeholder="Product Code: Ex. 01-01-01" required>
                                </div>
                                <div class="mt-5">
