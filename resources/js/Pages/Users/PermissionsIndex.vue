    ...
    <AuthenticatedLayout>
        ...
        <Modal :show="isAddModalOpen" @close="closeModal"> 
            <form @submit.prevent="submit">
                <div class="bg-zinc-300 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="w-full mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 class="text-lg leading-6 font-semibold text-[#1a0037]" id="modal-headline">Create New User Permission</h3>
                            <p class="text-sm text-zinc-700"> Enter the details for the new User Permission you wish to add.</p>
                            <div class="mt-10">
                                <p class="text-sm font-semibold text-[#1a0037] mb-2">User Permission</p>
                                <div class="relative z-0 w-full group my-1">
                                    <input v-model="create.permissionName" type="text" name="roleName" id="roleName" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-700 appearance-none focus:outline-none focus:ring-0 focus:border-indigo-600 peer" placeholder="" required />
                                    <label for="roleName" class="font-semibold text-zinc-700 absolute text-sm duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-indigo-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Enter Permission Name</label>
                ...
                <div class="bg-zinc-300 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                ...
                <div class="bg-zinc-300 h-auto">
                    <div class="p-6  md:mx-auto">
                        ...
                        <div class="text-center">
                            <h3 class="md:text-2xl text-base font-semibold text-[#1a0037] text-center">Delete Permission!</h3>
                            <p class="text-zinc-700 my-2">Confirming this action will remove the selected Permission into the list. This action can't be undone.</p>
