    ...
    <AuthenticatedLayout>
            ...
            <nav class="flex justify-between flex-col sm:flex-row" aria-label="Breadcrumb">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    <li class="flex flex-col lg:flex-row w-20">
                        <select v-model="selectedYear" id="filterYear" name="filterYear" @change="updateDaysInMonth"
                            class="w-full h-10 border-0 focus:border-0 text-gray-500 rounded px-2 md:px-3 py-0 md:py-1 bg-zinc-100">
                            <option disabled :value="null">Year</option>
                            <option v-for="year in years" :key="year" :value="year">{{ year }}</option>
                        </select>
                    </li>
                    <li class="flex flex-col lg:flex-row w-32">
                        <select v-model="selectedMonth" id="filterMonth" name="filterMonth" @change="updateDaysInMonth"
                            class="w-full h-10 border-0 focus:border-0 text-gray-500 rounded px-2 md:px-3 py-0 md:py-1 bg-zinc-100">
                    ...
                    <li class="flex flex-col lg:flex-row w-20">
                        <select v-model="selectedDay" id="filterDat" name="filterDay" @change="handleDateFilter"
                            class="w-full h-10 border-0 focus:border-0 text-gray-500 rounded px-2 md:px-3 py-0 md:py-1 bg-zinc-100">
            ...
            <div class="overflow-hidden">
                ...
                <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
                    <div class="flex items-center bg-zinc-300 rounded-md overflow-hidden">
                        <div class="p-4">
                            <svg class="h-12 w-12 text-indigo-600" xmlns="http://www.w3.org/2000/svg" fill="none"
                                stroke="currentColor" width="32" height="32" viewBox="0 0 48 48">
                        ...
                        <div class="px-4 text-gray-700">
                            <h3 class="text-sm tracking-wider">
                                <a class="hover:underline"
                                    :href="hasPermission('create-office-ppmp') || hasAnyRole(['Developer']) ? route('import.ppmp.index') : '#'">Office
                                    PPMP ({{ updatedCore.ppmpTransactions.year }})</a>
                            </h3>
                    ...
                    <div class="flex items-center bg-zinc-300 rounded-md overflow-hidden">
                        <div class="p-4">
                            <svg class="h-12 w-12 text-indigo-600" xmlns="http://www.w3.org/2000/svg" fill="none"
                                stroke="currentColor" width="32" height="32" viewBox="0 0 24 24">
                        ...
                        <div class="px-4 text-gray-700">
                            <h3 class="text-sm tracking-wider">
                                <a class="hover:underline"
                                    :href="hasPermission('view-app-list') || hasAnyRole(['Developer']) ? route('conso.ppmp.type', { type: 'consolidated', status: 'approved' }) : '#'">Consolidated
                                    PPMP ({{ updatedCore.consolidatedPpmp.year }})</a>
                            </h3>
                            <div class="flex justify-start items-center">
        ...
        <div class="mt-8 w-screen-2xl">
            <div class="overflow-hidden">
                ...
                <div class="grid grid-cols-1 gap-8 sm:grid-cols-4">
                    <div class="flex items-center bg-zinc-300 rounded-md overflow-hidden">
                        <div class="p-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-teal-600" fill="none"
                        ...
                        <div class="px-4 text-gray-700">
                            <h3 class="text-sm tracking-wider">
                                <a class="hover:underline"
                                    :href="hasPermission('view-iar-transaction-pending') || hasAnyRole(['Developer']) ? route('iar') : '#'">IAR
                                    Transaction</a>
                            </h3>
                            <div class="flex justify-start items-center">
                    ...
                    <div class="flex items-center bg-zinc-300 rounded-md overflow-hidden">
                        <div class="p-4">
                            <svg class="h-12 w-12 text-cyan-600" fill="none" stroke="currentColor"
                        ...
                        <div class="px-4 text-gray-700">
                            <h3 class="text-sm tracking-wider">
                                <a class="hover:underline"
                                    :href="hasPermission('view-ris-transactions') || hasAnyRole(['Developer']) ? route('ris.display.logs') : '#'">RIS
                                    Transaction</a>
                            </h3>
                            <div class="flex justify-start items-center">
                    ...
                    <div class="flex items-center bg-zinc-300 rounded-md overflow-hidden">
                        ...
                        <div class="px-4 text-gray-700">
                            <h3 class="text-sm tracking-wider">
                                <a class="hover:underline"
                                    :href="hasPermission('view-purchase-request-list') || hasAnyRole(['Developer']) ? route('pr.display.transactions') : '#'">Purchase
                                    Request</a>
                            </h3>
                            <div class="flex justify-start items-center">
                    ...
                    <div class="flex items-center bg-zinc-300 rounded-md overflow-hidden">
                        <div class="p-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-sky-600" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path fill="currentColor"
                        ...
                        <div class="px-4 text-gray-700">
                            <h3 class="text-sm tracking-wider">
                                <a class="hover:underline"
                                    :href="hasPermission('view-purchase-order') || hasAnyRole(['Developer']) ? route('pr.show.onProcess') : '#'">Purchase
                                    Order</a>
                            </h3>
                            <div class="flex justify-start items-center">
                ...
                <div class="grid grid-cols-1 gap-8 sm:grid-cols-4 mt-8">
                    <div class="flex items-center bg-zinc-300 rounded-md overflow-hidden">
                        ...
                        <div class="px-4 text-gray-700">
                            <h3 class="text-sm tracking-wider">
                                <a class="hover:underline"
                                    :href="hasPermission('view-products-inventory') || hasAnyRole(['Developer']) ? route('inventory.index', { priority: 'available' }) : '#'">Available
                                    On Inventory</a>
                            </h3>
                            <div class="flex justify-start items-center">
                    ...
                    <div class="flex items-center bg-zinc-300 rounded-md overflow-hidden">
                        <div class="p-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-amber-600" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path fill="currentColor"
                                    d="M19 4h-2V2h-2v2H9V2H7v2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2h14c1.103 0 2-.897 2-2V6c0-1.103-.897-2-2-2m-6 16h-2v-2h2zm0-4h-2v-5h2zm6-7H5V7h14z" />
                            </svg>
                        </div>
                        <div class="px-4 text-gray-700">
                            <h3 class="text-sm tracking-wider">
                                <a class="hover:underline"
                                    :href="hasPermission('monitor-expiring-products') || hasAnyRole(['Developer']) ? route('show.expiry.products') : '#'">Expiring
                                    Product Items</a>
                            </h3>
                            <div class="flex justify-start items-center">
                    ...
                    <div class="flex items-center bg-zinc-300 rounded-md overflow-hidden">
                                    ...
                                    <mask id="ipSOrder0">
                                        <g fill="none" stroke-linejoin="round" stroke-width="4">
                                            <path fill="#fff" stroke="#fff"
                                                d="M33.05 7H38a2 2 0 0 1 2 2v33a2 2 0 0 1-2 2H10a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h7v3h14V7z" />
                                            <path stroke="#fff" stroke-linecap="round" d="M17 4h14v6H17z" />
                                            <path stroke="#000" stroke-linecap="round"
                                                d="m27 19l-8 8.001h10.004l-8.004 8" />
                                        </g>
                                    </mask>
                                </defs>
                        ...
                        <div class="px-4 text-gray-700">
                            <h3 class="text-sm tracking-wider">
                                <a class="hover:underline"
                                    :href="hasPermission('view-products-inventory') || hasAnyRole(['Developer']) ? route('inventory.index', { priority: 'reorder' }) : '#'">Re-Order
                                    Product Items</a>
                            </h3>
                    ...
                    <div class="flex items-center bg-zinc-300 rounded-md overflow-hidden">
                        <div class="p-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-rose-600" fill="currentColor"
                                stroke="currentColor" viewBox="0 0 576 512">
                                <path fill="currentColor"
                        ...
                        <div class="px-4 text-gray-700">
                            <h3 class="text-sm tracking-wider">
                                <a class="hover:underline" :href="hasPermission('view-products-inventory') || hasAnyRole(['Developer'])
                                    ? route('inventory.index', { priority: 'out_of_stock' })
                                    : '#'">
                                    Out Of Stock
                                </a>
                            </h3>
        ...
        <div class="w-screen-2xl bg-zinc-300 shadow rounded-md mt-8 mb-4">
            <div class="flex flex-col justify-start my-4 px-5">
                ...
                <p class="text-gray-600 text-xs">Fast-moving items that are regularly out of stock due to strong demand.
                </p>
            </div>
            <div class="overflow-hidden px-4 shadow-sm sm:rounded-lg">
                <div class="relative overflow-x-auto">
                    <DataTable class="display table-hover table-striped shadow-lg rounded-lg bg-zinc-100"
                        :columns="columns" :data="fastMovingItems.products" :options="{
                            paging: false,
                            searching: false,
                            ordering: false,
                            info: false
