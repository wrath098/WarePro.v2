...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-3">Dashboard</h2>
        </template>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="grid grid-cols-1 gap-4 p-4 sm:grid-cols-4">
                        <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
                            <div class="p-4 bg-gradient-to-r from-pink-400  to-pink-600">
                            ...
                            <div class="px-4 text-gray-700">
                                <h3 class="text-sm tracking-wider">Category</h3>
                                <p class="text-3xl">{{ core.category }}</p>
                            </div>
                        </div>
                        <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
                            <div class="p-4 bg-gradient-to-r from-sky-400  to-sky-600">
                                <svg class="h-12 w-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M21.2505 5.77V9C21.2505 11.1146 20.5427 11.899 18.6312 12.0068C18.3555 12.0223 18.1305 11.7961 18.1305 11.52V10.38C18.1305 7.26 16.7405 5.87 13.6205 5.87H12.4805C12.2043 5.87 11.9781 5.64494 11.9937 5.36924C12.1014 3.45773 12.8859 2.75 15.0005 2.75H18.2305C20.5205 2.75 21.2505 3.48 21.2505 5.77Z" fill="currentColor"/>
                                    <path d="M16.6291 10.3811V13.6211C16.6291 15.9011 15.8991 16.6311 13.6191 16.6311H10.3791C8.09914 16.6311 7.36914 15.9011 7.36914 13.6211V10.3811C7.36914 8.10109 8.09914 7.37109 10.3791 7.37109H13.6191C15.8991 7.37109 16.6291 8.10109 16.6291 10.3811Z" fill="currentColor"/>
                            ...
                            <div class="px-4 text-gray-700">
                                <h3 class="text-sm tracking-wider">Item Class</h3>
                                <p class="text-3xl">{{ core.item }}</p>
                            </div>
                        </div>
                        <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
                            <div class="p-4 bg-gradient-to-r from-teal-400  to-teal-600">
                                <svg class="h-12 w-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 16 16" id="meteor-icon-kit__solid-products-s" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M7 5H14C15.1046 5 16 5.89543 16 7V14C16 15.1046 15.1046 16 14 16H7C5.89543 16 5 15.1046 5 14V7C5 5.89543 5.89543 5 7 5zM3 11H2C0.89543 11 0 10.1046 0 9V2C0 0.89543 0.89543 0 2 0H9C10.1046 0 11 0.89543 11 2V3H7C4.79086 3 3 4.79086 3 7V11z" fill="currentColor"/>
                                </svg>
                            </div>
                            <div class="px-4 text-gray-700">
                                <h3 class="text-sm tracking-wider">Products</h3>
                                <p class="text-3xl">{{ core.product }}</p>
                            </div>
                        </div>
                        <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
                            <div class="p-4 bg-gradient-to-r from-rose-400  to-rose-600">
                                <svg class="h-12 w-12 text-white" fill="currentColor" stroke="currentColor" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 544.527 544.527" xml:space="preserve">
                                    <g>
                                        <g>
                            ...
                            <div class="px-4 text-gray-700">
                                ...
                                <p class="text-3xl">{{ core.redorder }}</p>
                            </div>
                        </div>
                    </div>
                </div>
