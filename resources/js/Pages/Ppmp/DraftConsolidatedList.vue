                        ...
                        :options="{  paging: true,
                            ...
                            <template #action="props">
                                <span v-if="ppmp.status == 'Draft'">
                                    ...
                                    <button @click="openEditModal(props.cellData)" class="w-full inline-flex justify-center text-base sm:ml-3 sm:w-auto sm:text-sm" title="Edit">
...
<style scoped>
    ...
    :deep([data-v-ac57ac32] table.dataTable tbody > tr > td:nth-child(4)) {
