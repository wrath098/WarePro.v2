                                ...
                                <div class="flex items-center">
                                    <Dropdown>
                                        ...
                                        <template #content>
                                            ...
                                            <button @click="showModal('confirm')" class="flex w-full px-4 py-2 text-left text-sm leading-5 text-gray-700 hover:bg-indigo-100 focus:bg-indigo-100 transition duration-150 ease-in-out" disabled>
