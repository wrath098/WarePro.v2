                ...
                <div class="overflow-y-auto py-3 px-3 h-full">
                    <ul class="space-y-2">
                        ...
                        <li>
                            ...
                            <SidebarDropdown :active="$page.url.includes('pr/procurement-basis') || route().current('pr.form.step1') || route().current('pr.display.transactions')">

                                <svg
                                    class="w-6 h-6 text-indigo-900 transition duration-75 group-hover:text-white"
                                    :class="{'text-white': route().current('pr.display.procurementBasis') || route().current('pr.form.step1') || route().current('pr.display.transactions')}"
                                    fill="currentColor" 
                                    aria-hidden="true" 
                                    xmlns="http://www.w3.org/2000/svg" 
                                    viewBox="0 0 24 24"
                                ...
                                <ArrowDown :class="{'text-white': $page.url.includes('pr/procurement-basis') || route().current('pr.form.step1') || route().current('pr.display.transactions')}" />
                                <template #dropdown-items>
                                    <li>
