...
<template>
    <div>
        <nav class="flex items-center fixed w-screen h-16 z-40 top-0 left-0 bg-gradient-to-r from-indigo-500 to-purple-500 transition px-8 shadow-sm">
            <div class="w-80 flex items-center">
                ...
                <a :href="route('dashboard')" class="inline-flex items-center text-2xl rounded text-gray-700 font-medium gap-2">
                    <svg class="w-8 text-gray-50" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 32 32">
                    ...
                    <span class="text-gray-50 tracking-wider">WarePro</span>
                </a>
            </div>
        ...
        <main class="lg:ml-96 flex flex-col justify-between mt-16 lg:mr-8 transition">
            ...
            <slot />
            <footer class="mb-2 px-4 border-gray-500 z-10 flex lg:justify-end lg:items-end justify-center items-center">
                <div class="text-xs text-gray-400"> © 2025 PGSO Warehouse | Developed by C. & PGSO</div>
            </footer>
        </main>
    </div>
</template>
