...
<template>
    <div class="relative inline-block">
        <a :href="href" class="w-full inline-flex justify-center text-base sm:ml-3 sm:w-auto sm:text-sm" target="_blank" :aria-label="tooltip">
            <slot />
            <svg class="w-7 h-7" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                <defs>
                    <linearGradient id="SVGCSIZcbiK" x1="4.494" x2="13.832" y1="-1712.086" y2="-1695.914" gradientTransform="translate(0 1720)" gradientUnits="userSpaceOnUse">
                ...
                <path fill="#2b7cd3" d="M30 9.5H8.512V16l11.069 1.95L30 16Z"/><path fill="#185abd" d="M8.512 16v6.5l10.418 1.3L30 22.5V16Z"/>
                ...
                <path fill="url(#SVGCSIZcbiK)" d="M3.194 8.85h11.938a1.193 1.193 0 0 1 1.194 1.191v11.918a1.193 1.193 0 0 1-1.194 1.191H3.194A1.19 1.19 0 0 1 2 21.959V10.041A1.19 1.19 0 0 1 3.194 8.85"/>
        ...
        <div v-if="tooltip" class="absolute z-10 w-auto p-1 text-xs text-white bg-gray-800 rounded-lg tooltip">
            {{ tooltip }}
        </div>
    </div>
</template>
