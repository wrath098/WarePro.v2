...
Route::middleware('auth')->prefix('ppmp')->group(function () {
    ...
    Route::post('/particular/bulk-update', [PpmpConsolidatedController::class, 'bulkUpdate'])->name('ppmp.particular.bulk-update');
    ...
    Route::prefix('office')->group(function() {
        ...
        Route::get('/approved-ppmp', [PpmpTransactionController::class, 'officeApprovedPpmp'])->name('office.approved.ppmp');
    });
...
Route::middleware('auth')->prefix('iar')->group(function () {
    ...
    Route::post('/store-retrieve-transaction', [IarTransactionController::class, 'storeRetrieveTransaction'])->name('store.retrieve.iar.transaction');
...
Route::middleware('auth')->prefix('api')->group(function () {
    ...
    Route::get('/monthly-product-inventory-report', [MonthlyInventoryReportController::class, 'fetchMonthlyInventory'])->name('get.monthly.inventory.report');
